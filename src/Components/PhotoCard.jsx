...
const PhotoCard = () => {
  return (
    <div className='relative xl:w-[16vw] md:w-[20vw] h-[277px] rounded-[50px] shadow-[0px_6px_20px_rgba(188,188,188,0.25)] text-center'>
        ...
        <p className='text-[17px] font-[600] mt-[22px]'>Nirav Parmar</p>
        <button className='text-[10px] text-[#196C6C] w-[105px] bg-[#CEFFFF] h-[25px] rounded-[16px] mt-[6px]'>Album 1</button>
        <p className='text-[13px] text-[#8697B4] mt-[19px]'>niravparmar@gmail.com</p>
    </div>
  )
}
